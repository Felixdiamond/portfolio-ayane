...
// Subcomponent for Service Item to handle InView state individually
const ServiceItem = ({ 
  service, 
  index, 
  activeIndex, 
  ...
  return (
    ...
    >
      ...
      {/* Description & Tags - Reveal on hover or always visible? Kept hover logic but improved */}
      <div className={cn(
...
export default function Philosophy() {
  ...
  useGSAP(() => {
    ...
    // Parallax text effect - Row 2 (Reverse & Fast)
    gsap.fromTo(".philosophy-text-2", 
     ...
     // Parallax text effect - Row 3 (Same as 1)
  ...
  return (
    ...
    >
      ...
      {/* BACKGROUND IMAGE LAYER - Fixed/Absolute behind content */}
      ...
      <div className="max-w-7xl mx-auto px-5 relative z-10 w-full">
        {/* Kinetic Header (Restored 3-Row Style) */}
