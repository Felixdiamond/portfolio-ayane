  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uHueShift: { value: initialProps.hueShift },
        uNoise: { value: initialProps.noiseIntensity },
        uScan: { value: initialProps.scanlineIntensity },
        uScanFreq: { value: initialProps.scanlineFrequency },
        uWarp: { value: initialProps.warpAmount }
      }
    });
    ...
    const loop = () => {
      ...
      program.uniforms.uTime.value = ((now - start) / 1000) * currentProps.speed;
      ...
      program.uniforms.uWarp.value = currentProps.warpAmount;
