export const projects = [
  {
    ...
    des: "An identity and attendance system for schools, built end to end. I wrote the driver interface for the Futronic fingerprint scanner, the fingerprint and face recognition pipelines, and the web dashboard staff actually use. It runs in production, so the repo stays private.",
    img: "",
  ...
  },
  {
    ...
    des: "Re-voices video in 8 languages using WhisperX alignment, NLLB translation and Qwen3-TTS voice cloning, while Demucs splits the track so the background music survives the dub. Models load in sequence to fit one GPU's VRAM.",
  ...
  },
  {
    ...
    des: "Pulls a palette from your wallpaper and rebuilds the Marble GNOME theme around it, so the whole desktop follows the art. The most-starred thing I've shipped, and Linux ricers are a demanding audience.",
    img: "",
